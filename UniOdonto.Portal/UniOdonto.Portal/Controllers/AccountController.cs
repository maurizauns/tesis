    ...
    public class AccountController : Controller
    {
       ...
       [ValidateAntiForgeryToken]
        ...
        private async Task SignInAsync(ApplicationUser user, bool isPersistent)
        {
            ...
            //identity.AddClaim(new Claim(CustomClaimTypes.UserAgencyId, user.Empresa.Id.ToString()));
            identity.AddClaim(new Claim(CustomClaimTypes.UserAgencyId, user.Empresa.FirstOrDefault().Id.ToString()));
