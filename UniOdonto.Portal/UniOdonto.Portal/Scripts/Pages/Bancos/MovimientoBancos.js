...
copyPrototype(Movimiento, MasterDetail);

Movimiento.prototype.puedeEliminar = function () {
    return true;
}

function DetalleMovimiento(tr) {
...
DetalleMovimiento.sonIguales = function (detalle1, detalle2) {
    /* FunciÃ³n utilizada para verificar si dos objetos tipos DetalleMovimiento 
	son iguales. */
