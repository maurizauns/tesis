...
wait("Dental", function () {
    ...
    function Knockout(data) {
        ...
        vmOdonto.AccionesBackup = ko.observable("");
        ...
        vmOdonto.Backup = function () {
            ...
            vmOdonto.AccionesBackup(vmOdonto.Acciones());
        ...
        vmOdonto.Restore = function () {
            ...
            vmOdonto.Acciones(vmOdonto.AccionesBackup());
            ...
            $.get("/Odontograma/GetEntity?id=" + vmOdonto.Id()).done(function (data) {
                if (data != null) {
                    ...
                    for (var i = 0; i < data.Evoluciones.length; i++) {
                        var properties = new Object();
                        try {
                            var datasE = data.Evoluciones[i].EncuestaID();
                            var datas = data.Evoluciones[i].EvolucionDate();
                            var datas1 = data.Evoluciones[i].Diente();
                            var datas2 = data.Evoluciones[i].Pieza();
                            var datas3 = data.Evoluciones[i].Indicacion();
                            var datas4 = data.Evoluciones[i].Estado();
                            var datas5 = data.Evoluciones[i].Cara();
                            var datas6 = data.Evoluciones[i].Cara1();
                            var datas7 = data.Evoluciones[i].Cara2();
                            var datas8 = data.Evoluciones[i].Cara3();
                            var datas9 = data.Evoluciones[i].Cara4();
                            var datas10 = data.Evoluciones[i].Pieza2();
                        } catch (e) {
                            var datasE = data.Evoluciones[i].EncuestaID;
                            var datas = data.Evoluciones[i].EvolucionDate;
                            var datas1 = data.Evoluciones[i].Diente;
                    ...
                    vmOdonto.R8(data.R8);
                    vmOdonto.R9(data.R9);
                    vmOdonto.R10(data.R10);
                    vmOdonto.R11(data.R11);
                    vmOdonto.R12(data.R12);
                    vmOdonto.R13(data.R13);
                    vmOdonto.R14(data.R14);
                    vmOdonto.R15(data.R15);
                    vmOdonto.R16(data.R16);
                    ...
                    vmOdonto.M8(data.M8);
                    vmOdonto.M9(data.M9);
                    vmOdonto.M10(data.M10);
                    vmOdonto.M11(data.M11);
                    vmOdonto.M12(data.M12);
                    vmOdonto.M13(data.M13);
                    vmOdonto.M14(data.M14);
                    vmOdonto.M15(data.M15);
                    vmOdonto.M16(data.M16);

                    vmOdonto.Re1(data.Re1);
                    vmOdonto.Re2(data.Re2);
                    vmOdonto.Re3(data.Re3);
                    vmOdonto.Re4(data.Re4);
                    vmOdonto.Re5(data.Re5);
                    vmOdonto.Re6(data.Re6);
                    vmOdonto.Re7(data.Re7);
                    vmOdonto.Re8(data.Re8);
                    vmOdonto.Re9(data.Re9);
                    vmOdonto.Re10(data.Re10);
                    vmOdonto.Re11(data.Re11);
                    vmOdonto.Re12(data.Re12);
                    vmOdonto.Re13(data.Re13);
                    vmOdonto.Re14(data.Re14);
                    vmOdonto.Re15(data.Re15);
                    vmOdonto.Re16(data.Re16);

                    vmOdonto.Mo1(data.Mo1);
                    vmOdonto.Mo2(data.Mo2);
                    vmOdonto.Mo3(data.Mo3);
                    vmOdonto.Mo4(data.Mo4);
                    vmOdonto.Mo5(data.Mo5);
                    vmOdonto.Mo6(data.Mo6);
                    vmOdonto.Mo7(data.Mo7);
                    vmOdonto.Mo8(data.Mo8);
                    vmOdonto.Mo9(data.Mo9);
                    vmOdonto.Mo10(data.Mo10);
                    vmOdonto.Mo11(data.Mo11);
                    vmOdonto.Mo12(data.Mo12);
                    vmOdonto.Mo13(data.Mo13);
                    vmOdonto.Mo14(data.Mo14);
                    vmOdonto.Mo15(data.Mo15);
                    vmOdonto.Mo16(data.Mo16);
        ...
        vmOdonto.Save = function () {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    ...
                    Evoluciones: vmOdonto.EvolucionesConductoDesa_(),
                    Fecha: moment().format(),
                }),
                success: function (res) {

                    //res.Fecha = moment(res.Fecha).format("DD/MM/YYYY")
                    res.data.LoadTeeth = function () {
                        if (vmOdonto.IsOpen()) { vmOdonto.Backup(); }
                        vmOdonto.State("View");
                        vmOdonto.Id(res.data.Id);
                        vmOdonto.Fecha(res.data.Fecha);
                        vmOdonto.Comentarios(res.data.Comentarios);



                        var arrayProperties = new Array();
                        for (var i = 0; i < res.data.Evoluciones.length; i++) {
                            var properties = new Object();
                            try {
                                var datasE = res.data.Evoluciones[i].EncuestaID();
                                var datas = res.data.Evoluciones[i].EvolucionDate();
                                var datas1 = res.data.Evoluciones[i].Diente();
                                var datas2 = res.data.Evoluciones[i].Pieza();
                                var datas3 = res.data.Evoluciones[i].Indicacion();
                                var datas4 = res.data.Evoluciones[i].Estado();
                                var datas5 = res.data.Evoluciones[i].Cara();
                                var datas6 = res.data.Evoluciones[i].Cara1();
                                var datas7 = res.data.Evoluciones[i].Cara2();
                                var datas8 = res.data.Evoluciones[i].Cara3();
                                var datas9 = res.data.Evoluciones[i].Cara4();
                                var datas10 = res.data.Evoluciones[i].Pieza2();
                            } catch (e) {
                                var datasE = res.data.Evoluciones[i].EncuestaID;
                                var datas = res.data.Evoluciones[i].EvolucionDate;
                                var datas1 = res.data.Evoluciones[i].Diente;
                        ...
                        vmOdonto.R1(res.data.R1);
                        vmOdonto.R2(res.data.R2);
                        vmOdonto.R3(res.data.R3);
                        vmOdonto.R4(res.data.R4);
                        vmOdonto.R5(res.data.R5);
                        vmOdonto.R6(res.data.R6);
                        vmOdonto.R7(res.data.R7);
                        vmOdonto.R8(res.data.R8);
                        vmOdonto.R9(res.data.R9);
                        vmOdonto.R10(res.data.R10);
                        vmOdonto.R11(res.data.R11);
                        vmOdonto.R12(res.data.R12);
                        vmOdonto.R13(res.data.R13);
                        vmOdonto.R14(res.data.R14);
                        vmOdonto.R15(res.data.R15);
                        vmOdonto.R16(res.data.R16);

                        vmOdonto.M1(res.data.M1);
                        vmOdonto.M2(res.data.M2);
                        vmOdonto.M3(res.data.M3);
                        vmOdonto.M4(res.data.M4);
                        vmOdonto.M5(res.data.M5);
                        vmOdonto.M6(res.data.M6);
                        vmOdonto.M7(res.data.M7);
                        vmOdonto.M8(res.data.M8);
                        vmOdonto.M9(res.data.M9);
                        vmOdonto.M10(res.data.M10);
                        vmOdonto.M11(res.data.M11);
                        vmOdonto.M12(res.data.M12);
                        vmOdonto.M13(res.data.M13);
                        vmOdonto.M14(res.data.M14);
                        vmOdonto.M15(res.data.M15);
                        vmOdonto.M16(res.data.M16);

                        vmOdonto.Re1(res.data.Re1);
                        vmOdonto.Re2(res.data.Re2);
                        vmOdonto.Re3(res.data.Re3);
                        vmOdonto.Re4(res.data.Re4);
                        vmOdonto.Re5(res.data.Re5);
                        vmOdonto.Re6(res.data.Re6);
                        vmOdonto.Re7(res.data.Re7);
                        vmOdonto.Re8(res.data.Re8);
                        vmOdonto.Re9(res.data.Re9);
                        vmOdonto.Re10(res.data.Re10);
                        vmOdonto.Re11(res.data.Re11);
                        vmOdonto.Re12(res.data.Re12);
                        vmOdonto.Re13(res.data.Re13);
                        vmOdonto.Re14(res.data.Re14);
                        vmOdonto.Re15(res.data.Re15);
                        vmOdonto.Re16(res.data.Re16);

                        vmOdonto.Mo1(res.data.Mo1);
                        vmOdonto.Mo2(res.data.Mo2);
                        vmOdonto.Mo3(res.data.Mo3);
                        vmOdonto.Mo4(res.data.Mo4);
                        vmOdonto.Mo5(res.data.Mo5);
                        vmOdonto.Mo6(res.data.Mo6);
                        vmOdonto.Mo7(res.data.Mo7);
                        vmOdonto.Mo8(res.data.Mo8);
                        vmOdonto.Mo9(res.data.Mo9);
                        vmOdonto.Mo10(res.data.Mo10);
                        vmOdonto.Mo11(res.data.Mo11);
                        vmOdonto.Mo12(res.data.Mo12);
                        vmOdonto.Mo13(res.data.Mo13);
                        vmOdonto.Mo14(res.data.Mo14);
                        vmOdonto.Mo15(res.data.Mo15);
                        vmOdonto.Mo16(res.data.Mo16);


                        $.get("/Odontograma/GetEntityId/" + res.data.Id).done(function (dientes) {
                            dental.ResetTeethState();
                            dental.Draw();
                            vmOdonto.Dientes = dientes;
                            vmOdonto.Parse();
                            ...
                            console.log("The error is", res.data);
                        });
                    };

                    vmOdonto.UpdateCurrent(res.data);

                    vmOdonto.Odontogramas.unshift(res.data);
                    vmOdonto.SaveTeeths(res.data.Id);
                }
            });
        ...
        vmOdonto.UpdateCurrent = function (newItem) {
            ...
            vmOdonto.Acciones(newItem.Acciones);
        ...
        vmOdonto.UpdateTeeths = function (Id) {
            vmOdonto.Dientes.forEach(function (x) { x.OdontogramaID = Id; });
            $.post("/Odontograma/UpdateDientes2", { Dientes: vmOdonto.Dientes })
                .done(function (res) {
                    success("Odontograma actualizado exitosamente");
                    vmOdonto.State("View");
                    vmOdonto = {};
                    $("#Content").load("/Odontologia/Odontograma2");
                    $("#Content").show();
        ...
        vmOdonto.CoronaR = function (diente) {
            ...
            if (diente.CoronaR) {
                dental.Apply([{ diente: "d" + diente.Numero, pieza: "corona", fill: "transparent", stroke: "transparent" }]);
                dental.Apply([{ diente: "d" + diente.Numero, pieza: "corona", fill: "#1b037c", stroke: "#1b037c" }]);
