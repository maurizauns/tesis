...
{
    public class OdontogramaViewModel :BaseModel
    {
		...
		public virtual List<DienteViewModel> Dientes { get; set; }
		public virtual List<EvolucionesOdontogramaViewModel> Evoluciones { get; set; }
	}
}