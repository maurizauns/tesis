...
namespace UniOdonto.Models
{
    ...
    public class PersonDateTimeValidation
    {
        public static ValidationResult ValidaFechaNacimiento(string fecha)
        {
            DateTime date = DateTime.ParseExact(fecha, "dd/MM/yyyy", CultureInfo.InvariantCulture);

            return date > DateTime.Now
                ? new ValidationResult("La fecha de nacimiento del paciente debe ser menor o igual a la fecha actual.")
    ...
    public class TipoIdentificacionViewModel : BaseModel
    {
        ...
        public SubTipoIdentificacionViewModel SubTipoIdentificacion { get; set; }
